...
const CurrentForecast = () => {
    return (
        <>
            <div className='flex flex-col md:flex-row md:justify-between items-center w-full h-[286px] bg-(--blue-500) rounded-[20px] px-6 gap-4 py-10 bg-[url("./bg-today-small.svg")] md:bg-[url("./bg-today-large.svg")] bg-no-repeat bg-cover'>
