...
const HourlyForecast = ({chosenDay, handleChangeChosenDay}: HourlyForecastProps) => {
    ...
    return (
        <div className="h-[690px] w-full rounded-[20px] p-4 flex flex-col gap-4 bg-(--neutral-800) xl:flex-1">
            ...
            <ul className="h-full flex flex-col gap-4 overflow-y-auto scrollbar scrollbar-w-1 scrollbar-h-[262px] scrollbar-thumb-[#302F4A] scrollbar-thumb-rounded-full scrollbar-track-transparent">
